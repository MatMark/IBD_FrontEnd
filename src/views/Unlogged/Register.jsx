...
class Register extends Component {
    constructor(){
        ...
        this.state = {
            ...
            personal: {firstName: null, lastName: null, pesel: null, birthDate: null},
            contact: {phone: null, city: null, street: null, homeNumber: null, apartmentNumber: null, postCode: null},
          };
            ...
            <Card className='justify-content-center' border="primary" text="white">
                ...
                <OverlayTrigger
                    ...
                    <InputGroup>
                        ...
                        onChange={(e) => { this.setState({ 
                            login: {
                                email: this.state.login.email, password: e.target.value
                            }})}}
                        onKeyPress={(e) => {if (e.key === 'Enter') {e.preventDefault(); this.handleSubmit();}}}
                        />
                    </InputGroup>
        ...
        return(
           <Card className='justify-content-center' border="primary" text="white">
               ...
               <OverlayTrigger
                    ...
                    overlay={
                        <Tooltip>
                            <strong>Podaj swój numer telefonu składający się z 9 cyfr (bez numeru kierunkowego)</strong>
                        </Tooltip>
                    }>
                    <InputGroup>
                        <InputGroup.Prepend>
